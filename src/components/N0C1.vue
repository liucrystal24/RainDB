<template>
  ...
  >
    ...
    <bm-boundary name="吉林省" strokeWeight="5" strokeColor="#000000" fillOpacity="0"></bm-boundary>
...
export default {
  ...
  data() {
    return {
      ...
      // { lng: 123.54242, lat: 44.208405 }
      recPath1: [
        { lng: 124.3748975, lat: 44.7280815 },
        // { lng: 125.207375, lat: 44.208405 },
        { lng: 126.039852, lat: 43.688728 }
      ],
      recPath2: [
        { lng: 124.3748975, lat: 43.688728 },
        { lng: 126.039852, lat: 44.7280815 }
  ...
  methods: {
    ...
    handler({ BMap, map }) {
      ...
      this.center.lng = 126.57;
      this.center.lat = 43.87;
      this.zoom = 8;
