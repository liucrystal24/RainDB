  ...
  <div>
    ...
    <div class="resultcontainer">
      <el-row class="searchtitle">
        ...
        <el-col :span="20">
          <div class="titletext">FY4A文件</div>
        </el-col>
      </el-row>
      <div class="tableContainer">
        ...
        >
          ...
          <el-table-column label="band" header-align="center" align="center">
            <template slot-scope="scope">
              <span style="margin-left:10px">{{ scope.row["band"] }}</span>
            </template>
          </el-table-column>
    ...
    handleDownload(index, row) {
      ...
      this.axios({
        ...
        .then(res => {
          ...
          let filename = band === "V0001" ? ".NC" : ".HDF";
          link.setAttribute("download", datefirst + datesecond + filename);
